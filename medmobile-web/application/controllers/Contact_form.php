...
class Contact_form extends My_Controller {
  ...
  public function add_report() {
    ...
    $this->load->helper('string');
    $this->load->library('email');
    $pat_id =   $this->input->post('name', true);
    $symptom_id =    $this->input->post('yob', true);
    $issue_id = $this->input->post('issue_id', true);
    $diagnosis_result =  $this->input->post('diagnosis_result', true);
      $data = array('pat_id' => $pat_id, 'symptom_id'=> $symptom_id, 'issue_id' => $issue_id,'diagnosis_result'=>$diagnosis_result);
