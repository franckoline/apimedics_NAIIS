...
function puyModal(options) {
  ...
  if (that.showHeader) {
    ...
    html += '<a href="#" class="btn btn-primary btn-sm" onclick="dwnld()"><i class="fa fa-download " title="Download CV" aria-hidden="true"></i>   Download</a>';
    // html += '<a href="#" onclick="download()"> Download</a>';
    // html += '<a href="#3" onclick="daga("3")"> Tmp 3</a>';
    // html += '<a href="#4" onclick="daga(4)"> Tmp 4</a>';
    // html += '<a href="#5" onclick="daga()"> Tmp 4</a>';
    html += '</div>';
  ...
  if (that.showFooter) {
    ...
    html += '<a href="#1" onclick="daga('+prev+')"><i class="fa fa-arrow-circle-left text-primary" title="Quick Quick CV" aria-hidden="true"></i>   Previous Design</a>';
    html += '<a href="#2" onclick="daga('+next+')"> <i class="fa fa-arrow-circle-right text-primary" title="Quick Quick CV" aria-hidden="true"></i>   Next Design</a>';    
    html += '</div>';
  }
  html += '</div>';
  html += '</div>';
